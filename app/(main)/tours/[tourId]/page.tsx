...
export default function TourDetailsPage() {
  ...
  const handleBookTour = () => {
    ...
    if (!userData.address || !userData.phone) {
      toast.error('Please update your profile with address and phone number before booking.');
      return;
    }
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
        <div className="bg-white p-10 rounded-3xl shadow-xl text-center max-w-lg">
          ...
          <p className="text-gray-600 mb-8">The experience you're looking for doesn't exist or has been removed from our listings.</p>
          <Link 
            href="/"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex items-center text-amber-500 font-bold text-sm">
                    ...
                    {tour.rating || 4.8}
                    <span className="text-gray-400 font-medium ml-1">({tour.reviewCount || 0} reviews)</span>
                  </div>
                </div>
              ...
              <div className="flex border-b border-gray-100 mb-10 overflow-x-auto scrollbar-hide">
                {['Overview', 'Itinerary', 'Reviews', 'Important Info'].map((tab) => (
                  <button
                    key={tab}
                    onClick={() => setActiveTab(tab.toLowerCase())}
                    className={`pb-4 px-6 text-sm font-bold tracking-wide uppercase transition-all relative min-w-max ${
                      activeTab === tab.toLowerCase() ? 'text-[#4088FD]' : 'text-gray-400 hover:text-gray-600'
                    }`}
                  >
                    {tab}
              ...
              <div className="min-h-[400px]">
                <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                          About this <span className="text-[#4088FD]">Experience</span>
                        </h3>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {tour.highlights.map((h: string, i: number) => (
                              <div key={i} className="flex items-start gap-3 p-4 bg-blue-50/50 rounded-2xl border border-blue-100/30">
                  ...
                  {activeTab === 'itinerary' && (
                    ...
                    >
                      <h3 className="text-2xl font-bold text-gray-900 mb-8">Full Itinerary</h3>
                        ...
                        {tour.itinerary?.map((item: any, i: number) => (
                          <div key={i} className="flex gap-8 group">
                            ...
                            <div className="pb-12 pt-1 flex-1">
                              ...
                              <p className="text-gray-600 leading-relaxed font-medium opacity-80">{item.description}</p>
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  {activeTab === 'reviews' && (
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-gray-100">
                        <div>
                          <h3 className="text-3xl font-black text-gray-900 mb-2">Guest reviews</h3>
                          <p className="text-gray-500 font-medium">Based on {tour.reviewCount || 0} real local experiences</p>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="text-center">
                                <div className="text-5xl font-black text-[#4088FD]">{tour.rating || 4.8}</div>
                                <div className="flex items-center justify-center mt-2">
                                  {[1,2,3,4,5].map(s => <Star key={s} className="w-3 h-3 text-amber-500 fill-current" />)}
                                </div>
                            </div>
                            <div className="h-16 w-px bg-gray-100" />
                            <Link href="#" className="font-bold text-sm text-[#4088FD] hover:underline">Write a review</Link>
                        </div>
                      </div>
                      ...
                      {isLoadingReviews ? (
                        ...
                        <div className="text-center py-20 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
                          <p className="text-gray-400 font-bold">No reviews yet. Be the first to share your journey!</p>
                        </div>
                      ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          {reviews.map((r: any) => (
                            <div key={r._id} className="p-8 rounded-[2.5rem] bg-white border border-gray-100 hover:shadow-xl hover:shadow-gray-500/5 transition-all duration-300">
                              <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center gap-3">
                                  <div className="w-12 h-12 rounded-2xl overflow-hidden bg-gray-100">
                                    <img 
                                      src={r.userId?.image || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=150&q=80'} 
                                      className="w-full h-full object-cover" 
                                    />
                                  </div>
                                  <div>
                                    <h5 className="font-bold text-gray-900">{r.userId?.name || 'Local Explorer'}</h5>
                                    <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">{new Date(r.createdAt).toLocaleDateString()}</p>
                                  </div>
                                </div>
                              ...
                              <p className="text-gray-600 font-medium italic leading-relaxed">"{r.comment}"</p>
                            </div>
                          ))}
                        </div>
                      )}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                         {tour.importantInfo && tour.importantInfo.length > 0 && (
                           <div className="space-y-6">
                              <h3 className="text-2xl font-bold text-gray-900">Good to know</h3>
                              <div className="space-y-4">
                                {tour.importantInfo.map((info: string, i: number) => (
                                  <div key={i} className="flex items-start gap-3">
                                    <Info className="w-5 h-5 text-blue-500 mt-0.5 shrink-0" />
                                    <p className="text-gray-600 leading-relaxed font-medium">{info}</p>
                                  </div>
                                ))}
                              </div>
                           </div>
                         ...
                         <div className="space-y-6">
                            ...
                            <div className="p-8 rounded-3xl bg-blue-50/50 border border-blue-100">
                               <div className="flex items-start gap-4 mb-4">
                                  ...
                                  <div>
                                     <h4 className="font-bold text-gray-900 text-lg mb-1">Worry-free booking</h4>
                                     <p className="text-[#4088FD] font-bold text-sm">Flexible cancellation options available</p>
                                  </div>
                               </div>
                               <p className="text-gray-600 font-medium leading-relaxed">
                                 {tour.cancellationPolicy || "Full refund up to 24 hours before your experience begins. No refunds for cancellations within 24 hours."}
                               </p>
                            </div>
                         </div>
                      </div>
                ...
                <div className="relative p-1 rounded-[3rem] bg-gradient-to-br from-[#4088FD]/20 via-transparent to-blue-500/10 shadow-2xl shadow-blue-500/10">
                  <div className="bg-white rounded-[2.8rem] p-8">
                    <div className="flex items-end justify-between mb-8">
                      <div>
                        <div className="text-4xl font-black text-gray-900">{tour.tourFee} TK</div>
                        <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Per person</div>
                      </div>
                    ...
                    <div className="space-y-4 mb-8">
                       <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100">
                          <div className="flex items-center gap-3">
                             ...
                             <div>
                                <div className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Arrival</div>
                                <div className="text-sm font-bold text-gray-900">Select Date</div>
                             </div>
                          </div>
                       ...
                       <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100">
                          <div className="flex items-center gap-3">
                             ...
                             <div>
                                <div className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Guests</div>
                                <div className="text-sm font-bold text-gray-900">1 person</div>
                             </div>
                          </div>
                          <ChevronRight className="w-4 h-4 text-gray-300" />
                       </div>
                    ...
                    {!userData && (
                      <p className="text-center text-xs text-gray-400 font-bold mt-4 uppercase tracking-wider">
                        Please <Link href="/login" className="text-[#4088FD]">Login</Link> to secure your spot
                      </p>
                    )}
                    
                    <div className="mt-8 pt-8 border-t border-gray-100 grid grid-cols-2 gap-4">
                       <div className="text-center">
                          <div className="text-lg font-black text-gray-900">{tour.bookingCount || 0}</div>
                          <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Bookings</div>
                       </div>
                       <div className="text-center">
                          <div className="text-lg font-black text-gray-900">{tour.reviewCount || 0}</div>
                ...
                {tour.guideId && (
                  ...
                  >
                    <div className="flex items-center justify-between mb-8">
                       <h3 className="text-sm font-black uppercase tracking-widest text-[#4088FD]">Your Guide</h3>
                       <div className="px-3 py-1 bg-blue-50 text-[#4088FD] rounded-full text-[10px] font-black uppercase tracking-wider">Verified</div>
                    </div>
                    ...
                    <div className="flex items-center gap-5 mb-8">
                      <div className="relative shrink-0">
                        <div className="w-20 h-20 rounded-3xl overflow-hidden shadow-lg">
                          <img 
                            src={tour.guideId.image || 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?auto=format&fit=crop&w=150&q=80'} 
                            className="w-full h-full object-cover" 
                          />
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                           ...
                           <span className="text-xs font-bold text-gray-400">120+ tours done</span>
                        </div>
                      </div>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                       <button className="py-4 bg-gray-50 hover:bg-gray-100 transition-all rounded-2xl text-xs font-black text-gray-900 border border-gray-100 flex items-center justify-center gap-2">
                         <Mail className="w-4 h-4 text-[#4088FD]" /> Message
                       </button>
                       <button className="py-4 bg-gray-50 hover:bg-gray-100 transition-all rounded-2xl text-xs font-black text-gray-900 border border-gray-100 flex items-center justify-center gap-2">
                         <Phone className="w-4 h-4 text-[#4088FD]" /> Call
                       </button>
                    </div>
                  </motion.div>
                )}
        ...
        <DialogContent className="max-w-md p-0 overflow-hidden rounded-[2.5rem] border-none shadow-2xl">
          <div className="bg-[#4088FD] p-10 text-white relative">
            ...
            <DialogHeader className="relative z-10">
              <DialogTitle className="text-3xl font-black leading-tight text-white mb-2">Book your<br/>local journey</DialogTitle>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t border-gray-100 space-y-3">
                <div className="flex justify-between items-center text-sm font-medium text-gray-400">
                  ...
                  <span className="text-gray-900 font-bold">{totalPrice} TK</span>
                </div>
                <div className="flex justify-between items-center pt-2">
                  <span className="text-xl font-black text-gray-900">Total Price</span>
                  <span className="text-3xl font-black text-[#4088FD]">{totalPrice} TK</span>
                </div>
              </div>
            </div>
