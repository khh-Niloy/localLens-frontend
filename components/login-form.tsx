      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="space-y-5">
           <div className="space-y-2">
              <label className="text-sm font-black text-gray-900 uppercase tracking-widest pl-1" htmlFor="email">Email</label>
              ...
              {errors.email && (
                <p className="text-red-500 text-xs font-bold pl-1">{errors.email.message}</p>
              )}
           </div>

           <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                 <label className="text-sm font-black text-gray-900 uppercase tracking-widest" htmlFor="password">Password</label>
                 <a href="#" className="text-xs font-bold text-[#4088FD] hover:underline">Forgot?</a>
              </div>
              ...
              {errors.password && (
                <p className="text-red-500 text-xs font-bold pl-1">{errors.password.message}</p>
              )}
           </div>
        </div>
        ...
        <div className="space-y-6 pt-2">
          ...
          <p className="text-center text-sm font-bold text-gray-400">
             New to LocalLens?{" "}
             <Link href="/register/tourist" className="text-[#4088FD] hover:underline decoration-2 underline-offset-4">Create account</Link>
          </p>
          ...
          <div className="relative py-4">
             ...
             <div className="relative flex justify-center text-xs uppercase font-black text-gray-300">
                <span className="bg-white px-4 tracking-[0.3em]">Demo Access</span>
             </div>
          </div>

          <div className="grid grid-cols-3 gap-3">
             {[
               { name: "Tourist", email: "khhniloy01@gmail.com" },
